...
If `{story_key}` is not empty and `/home/alex/pets/jev-trade/_bmad-output/implementation-artifacts/sprint-status.yaml` exists, read `/home/alex/pets/jev-trade/_bmad/render/bmad-build/jev-trade-ca1ef59b338d/002dc69e796ba785f649/sync-sprint-status.md` with `{target_status}` = `in-progress`.
...
If `{story_key}` is not empty and `/home/alex/pets/jev-trade/_bmad-output/implementation-artifacts/sprint-status.yaml` exists, read `/home/alex/pets/jev-trade/_bmad/render/bmad-build/jev-trade-ca1ef59b338d/002dc69e796ba785f649/sync-sprint-status.md` with `{target_status}` = `review`.
